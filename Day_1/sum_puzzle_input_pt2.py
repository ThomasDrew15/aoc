...
#find pair of numbers that sum to target number, 3 refers to number of integers expected
solutions = [pair for pair in permutations(expenses, 3) if sum(pair) == target_number]
